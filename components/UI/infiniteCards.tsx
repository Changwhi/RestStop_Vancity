...
import InitialCircleIcon from "./initialCircleIcon";
          ...
          >
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                ...
                <div className="me-3">
                  {/* <Image width={50} height={50} src="/components/profilePic/profile.svg" alt="profile" /> */}
                  <InitialCircleIcon initial={item.name[0]} bgColor="bg-blue-500" />
                </div>
